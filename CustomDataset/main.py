...
#print(extract_info_from_xml(os.path.sep.join([annotationsPath, 'road4.xml'])))
...
def convert_to_yolov5(info_dict):
    ...
    save_file_name = os.path.join(
        annotationsPath, info_dict["filename"].replace("png", "txt"))
...
annotations = [os.path.join(annotationsPath, x)
               for x in os.listdir(annotationsPath) if x[-3:] == "xml"]
annotations.sort()
...
image_file = annotation_file.replace(annotationsPath, imagesPath).replace("txt", "png")
